...
- **🏗️ Build**: Overhauled the global `Hero.astro` component and all inner page configurations to incorporate beautiful showcase photos (`about.json`, `contact.json`, `services.json`, `siding-safety.json`) or centered compact layouts (`accessibility.json`, `privacy.json`, `terms.json`), completely eliminating bland homepage video duplicates and blank gray placeholders. (2026-05-26)
