...
- **🏗️ Build**: Overhauled the global `Hero.astro` to display the OMWBE and GSI partner badges prominently right inside the hero content column below the CTAs at a highly readable **80px height** (fully responsive down to 65px on mobile). This puts these massive trust credentials front-and-center at the absolute top of the homepage and all inner pages, resolving user complaints about small hidden footer images. (2026-05-26)
